                ...
                for region_orbit=orbit_Start_Index:orbit_End_Index
                    ...
                    if electronIndex_End >= electronIndex_Start
                        ...
                        for channel=3:5
                            ...
                            activeList = TopFluxes{regionIndex,channelIndex};

                            [TopFluxes{regionIndex,channelIndex},magneticIndexCurrent] = AL.fluxFilter(startTime,endTime,TEC,magneticTime,magneticIndexCurrent,cluster,activeList);
